...
import CustomVideoPlayer from "@/components/iitjee/CustomVideoPlayer";
...
interface Content {
  id: number;
  video: Video;
  pdf?: PDF; // Made optional to reflect cases where pdf might not exist
}
...
export default function Page() {
  ...
  const subjects = [
    ...
    ...Array.from(
      new Set(
        allContent
          .filter((item) => item?.pdf?.subject) // Only include items with pdf.subject
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1 animate-fade-in">
                  ...
                  <p className="text-lg md:text-xl text-gray-600 mb-6">
                    Join India's premier mentorship platform designed by IITians
                    to help you crack one of the toughest exams. Get
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button className="border-cogenist-indigo text-cogenist-indigo hover:bg-cogenist-light normal-case" onClick={onHandleClick}>
                      Explore Resources
                    </Button>
                  </div>
                </div>
            ...
            <div className="mb-12 animate-fade-in">
              <div className="rounded-lg overflow-hidden shadow-xl">
                <CustomVideoPlayer
                  ...
                  primaryColor="#9333EA" // Matches jeepurple-600
                />
              </div>
